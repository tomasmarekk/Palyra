        ...
        for scenario in selected_scenarios {
            scenario_records.push(skipped_record(
                ExecutionDescriptor {
                    ...
                    fake_provider: scenario.fake_provider,
                    fake_external_services: scenario.fake_external_services,
                    failure_report_fields: scenario.failure_report_fields.as_slice(),
...
struct ExecutionDescriptor<'a> {
    ...
    required: bool,
    fake_provider: bool,
    fake_external_services: bool,
    failure_report_fields: &'a [String],
    command: &'a [String],
}
...
fn execute_entry(
    ...
    Ok(WorkflowRegressionExecutionRecord {
        ...
        fake_provider: entry.fake_provider,
        fake_external_services: entry.fake_external_services,
        failure_report_fields: entry.failure_report_fields.to_vec(),
