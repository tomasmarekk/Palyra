...
use cli::{
    ...
    ApprovalDecisionArg, ApprovalExportFormatArg, ApprovalsCommand, AuthAccessCommand,
    ...
    PatchBundleCommand, PatchCommand, PluginsCommand, PolicyCommand, ProtocolCommand, QaCommand,
    RemoteVerificationModeArg, RunCommand, RunControlActivePhaseArg, RunControlCommandArg,
    RunExportFormatArg, SandboxCommand, SandboxRuntimeArg, SecretsCommand, SecurityCommand,
    SessionsCommand, SetupWizardOverridesArg, SkillsCommand, SkillsPackageCommand, StateCommand,
...
fn run_cli() -> Result<()> {
    ...
    match cli.command {
        ...
        CliCommand::Tasks { command } => commands::tasks::run_tasks(command),
        CliCommand::Jobs { command } => commands::jobs::run_jobs(command),
        CliCommand::Commitments { command } => commands::commitments::run_commitments(command),
        ...
        CliCommand::Qa { command } => commands::qa::run_qa(command),
