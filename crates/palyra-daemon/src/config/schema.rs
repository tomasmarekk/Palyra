...
pub(super) const MAX_GATEWAY_TAPE_ENTRIES_PER_RESPONSE: usize = 10_000;
...
pub struct FeatureRolloutsConfig {
    ...
    pub browser_resilience: FeatureRolloutSetting,
    pub audio_pipeline: FeatureRolloutSetting,
    pub computer_use: FeatureRolloutSetting,
    pub semantic_memory_consolidation: FeatureRolloutSetting,
...
/// Automatic memory injection and its per-prompt item cap.
#[derive(Debug, Clone, PartialEq, Eq)]
