...
mod tests {
    ...
    fn loaded_with_model_provider(model_provider: ModelProviderConfig) -> LoadedConfig {
        LoadedConfig {
            ...
            api_facade: Default::default(),
            mcp_servers: Default::default(),
            execution_backend_profiles: Default::default(),
            qa_lab: Default::default(),
            observability_exporters: Default::default(),
            hook_policy: Default::default(),
            agent_harness_registry: Default::default(),
            doctor_check_registry: Default::default(),
