...
#[cfg(test)]
mod tests {
    use super::suggestion_guard::{
        routine_suggestion_guard_projection, RoutineSuggestionBlueprint,
        RoutineSuggestionGuardDecision, RoutineSuggestionGuardInput,
        RoutineSuggestionGuardReasonCode,
    };
    use super::{
