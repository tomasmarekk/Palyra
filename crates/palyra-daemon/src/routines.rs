...
#[allow(dead_code)]
pub const ROUTINE_SUGGESTION_SCHEMA_VERSION: u64 = 1;

/// Blueprint family used when proposing a routine without activating it.
#[allow(dead_code)]
#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum RoutineSuggestionBlueprint {
    PeriodicDigest,
    Reminder,
    Monitor,
    Cleanup,
...
pub struct RoutineSuggestionGuardInput {
...
#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum RoutineSuggestionGuardDecision {
    PendingCandidate,
    ApprovalRequired,
    Rejected,
}
...
pub enum RoutineSuggestionGuardReasonCode {
...
#[allow(dead_code)]
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct RoutineSuggestionGuardProjection {
...
#[must_use]
#[allow(dead_code)]
pub fn routine_suggestion_guard_projection(
...
mod tests {
    use super::{
        ...
        routine_suggestion_guard_projection, schedule_requires_auto_enable_guard,
        ...
        RoutineSuggestionBlueprint, RoutineSuggestionGuardDecision, RoutineSuggestionGuardInput,
        RoutineSuggestionGuardReasonCode, RoutineTriggerKind,
        CRON_ROUTINE_PREVIEW_AUDIT_EVENT_COMPLETED, CRON_ROUTINE_PREVIEW_AUDIT_EVENT_STARTED,
        CRON_ROUTINE_PREVIEW_AUDIT_REDACTION_LEVEL, CRON_ROUTINE_PREVIEW_AUDIT_SCHEMA_VERSION,
        ...
        MIN_AUTO_ENABLE_EVERY_INTERVAL_MS, ROUTINE_CAPABILITY_PROFILE_EVENT_COMPLETED,
    ...
    #[test]
    fn routine_suggestion_guard_keeps_safe_report_pending() {
        let input = RoutineSuggestionGuardInput {
            blueprint: RoutineSuggestionBlueprint::Report,
            trigger_kind: RoutineTriggerKind::Schedule,
            approval_mode: RoutineApprovalMode::None,
            max_runs: Some(4),
        ...
        assert_eq!(projection.activation_state, "pending_candidate");
        assert!(projection
            .reason_codes
            .contains(&RoutineSuggestionGuardReasonCode::OwnerScopeRecorded));
        assert!(!projection.trace_json.contains("user:ops"));
    }

    #[test]
    fn routine_suggestion_guard_rejects_self_scheduling_and_unbounded_retry() {
        let input = RoutineSuggestionGuardInput {
            blueprint: RoutineSuggestionBlueprint::Monitor,
            trigger_kind: RoutineTriggerKind::Schedule,
            approval_mode: RoutineApprovalMode::BeforeFirstRun,
            max_runs: None,
        ...
        assert_eq!(projection.decision, RoutineSuggestionGuardDecision::Rejected);
        assert!(projection
            .reason_codes
            .contains(&RoutineSuggestionGuardReasonCode::SelfSchedulingRejected));
        assert!(projection
            .reason_codes
            .contains(&RoutineSuggestionGuardReasonCode::UnboundedRetryRejected));
    }
