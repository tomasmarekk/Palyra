...
mod tests {
    ...
    fn runtime_preview_snapshot_defaults_to_preview_only_and_disabled_mix() {
        let config = crate::config::LoadedConfig {
            ...
            acp_runtime: crate::config::AcpRuntimeConfig::default(),
            ...
            api_facade: crate::config::RoadmapPreviewSectionConfig::default(),
            ...
            qa_lab: crate::config::RoadmapPreviewSectionConfig::default(),
            observability_exporters: crate::config::ObservabilityExportersConfig::default(),
            hook_policy: crate::config::RoadmapPreviewSectionConfig::default(),
            agent_harness_registry: crate::config::AgentHarnessRegistryConfig::default(),
            doctor_check_registry: crate::config::DoctorCheckRegistryConfig::default(),
