...
mod tests {
    ...
    fn runtime_preview_snapshot_defaults_to_preview_only_and_disabled_mix() {
        let config = crate::config::LoadedConfig {
            ...
            api_facade: crate::config::RuntimePreviewSectionConfig::default(),
            ...
            qa_lab: crate::config::RuntimePreviewSectionConfig::default(),
            observability_exporters: crate::config::ObservabilityExportersConfig::default(),
            hook_policy: crate::config::RuntimePreviewSectionConfig::default(),
