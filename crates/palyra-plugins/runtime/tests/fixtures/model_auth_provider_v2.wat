;; Reference model-auth guest for executable ABI v2 conformance.
;; The output contains only a host-issued opaque secret-lease handle; no raw
;; credential bytes can be represented by the typed result.
(module
  ...
  (func (export "palyra-abi-v2-invoke")
    ...
    local.get $request-pointer i32.load8_u offset=10 i32.const 6 i32.ne
    if i32.const -10 return end
