;; Reference tool-result middleware guest for executable ABI v2 conformance.
;; Its output stays subject to host-side mutation-class and approval
;; monotonicity validation after crossing guest linear memory.
(module
  ...
  (func (export "palyra-abi-v2-invoke")
    ...
    local.get $request-pointer i32.load8_u offset=10 i32.const 3 i32.ne
    if i32.const -10 return end
