;; Reference context-engine guest for executable ABI v2 conformance.
;; The module validates its typed contract tag before returning a bounded
;; candidate projection through guest linear memory.
(module
  ...
  (func (export "palyra-abi-v2-invoke")
    ...
    local.get $request-pointer i32.load8_u offset=10 i32.const 2 i32.ne
    if i32.const -10 return end
