;; Reference agent-harness guest for the executable ABI v2 conformance suite.
;; The fixture proves that the contract tag and request bytes reached guest
;; memory before emitting an event and returning typed output bytes.
(module
