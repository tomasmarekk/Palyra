...
pub(crate) const BROWSER_RESILIENCE_PROFILE_ENV: &str = "PALYRA_BROWSERD_RESILIENCE_PROFILE";
...
/// File extensions eligible for the download allowlist directory; artifacts must pass both
/// extension and MIME checks or they are routed to quarantine instead.
pub(crate) const DOWNLOAD_ALLOWED_EXTENSIONS: &[&str] = &[
    "7z", "aac", "avif", "bmp", "br", "bz2", "conf", "css", "csv", "doc", "docx", "eot", "flac",
    "gif", "gz", "heic", "heif", "ico", "ini", "jpeg", "jpg", "json", "jsonl", "log", "m4a", "m4v",
    "map", "markdown", "md", "mov", "mp3", "mp4", "mpeg", "mpg", "odf", "odp", "ods", "odt", "oga",
    "ogg", "opus", "otf", "pdf", "png", "ppt", "pptx", "rar", "rtf", "tar", "tbz2", "tgz", "tif",
    "tiff", "toml", "tsv", "ttf", "txt", "wav", "webm", "webp", "woff", "woff2", "xls", "xlsx",
    "xz", "yaml", "yml", "zip", "zst",
];
