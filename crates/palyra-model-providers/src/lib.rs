...
pub use config::{
    ...
    resolve_openai_base_url_network_policy, resolve_openai_base_url_network_policy_with_resolver,
    ...
    ModelProviderKind, ModelProviderRegistryConfig, ProviderBaseUrlNetworkTarget,
    ProviderCapabilitiesSnapshot, ProviderCostTier, ProviderLatencyTier, ProviderMetadataSource,
    ProviderModelEntryConfig, ProviderModelRole, ProviderRegistryEntryConfig,
    DEFAULT_MODEL_PROVIDER_REQUEST_TIMEOUT_MS, DEFAULT_PROVIDER_DISCOVERY_TTL_MS,
    DEFAULT_PROVIDER_HEALTH_TTL_MS, DEFAULT_PROVIDER_RESPONSE_CACHE_MAX_ENTRIES,
    DEFAULT_PROVIDER_RESPONSE_CACHE_TTL_MS,
};
pub use contract::{
    ...
    provider_request_has_vision, AudioSynthesisRequest, AudioSynthesisResponse,
...
pub use qa_mock::{
    ...
    MAX_QA_MOCK_PROVIDER_FIXTURE_BYTES, MAX_QA_MOCK_PROVIDER_PROVENANCE_LABEL_LEN,
    MAX_QA_MOCK_PROVIDER_TOTAL_LATENCY_MS, QA_MOCK_PROVIDER_FIXTURE_FORMAT,
    QA_MOCK_PROVIDER_FIXTURE_SCHEMA_VERSION, QA_MOCK_PROVIDER_REDACTION_CONTRACT,
};
pub use redaction::{
