...
cargo test -p palyra-daemon --locked application::mcp_runtime::registry::tests::capacity_soak_drains_actor_fleet_without_orphans_across_restarts
cargo test -p palyra-daemon --locked journal::state_health::tests::retry_sqlite_busy_retries_transient_busy_errors
