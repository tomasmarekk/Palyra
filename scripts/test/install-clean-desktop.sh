...
desktop_runtime_root="$state_root/desktop-control-center/runtime"
...
"$cli_command_path" --state-root "$desktop_runtime_root" skills seed-e2e-fixtures --json >/dev/null
"$cli_command_path" --state-root "$desktop_runtime_root" skills list --json > "$workspace_root/e2e-skills-list.json"
